...
export default function DropDownList({value, setValue, listItem, attribute = 'max-w-36 sm:w-full'}){
    ...
    return (
        <>
            <select id="default" onChange={(e) => setValue(e.target.value)} class={css}>
