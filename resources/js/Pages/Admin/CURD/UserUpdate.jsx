...
export default function ({roles, user, userRoles}){
                ...
                <div
                    ...
                    <form onSubmit={submitForm}>
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div className="w-full">
                                <label htmlFor="matKhau"
                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Thay đổi mật khẩu (nếu có)</label>
                                <TextInput
                                    value={data.password}  
                        ...
                        <Flex justifyContent={"end"} className={"mt-4 space-x-4"}>
                            <Button disabled={processing}>Cập nhật người dùng</Button>
                            <Link href={"/admin/user"} method="get">
